...
Esta interface simples python-only demonstra uma das técnicas mais sofisticadas do mundo para proteger dados utilizando um truque matemático fantástico
